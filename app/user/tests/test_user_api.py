...
class PublicUserApiTests(TestCase):
    ...
    # make sure the password is long enough for security concern
    def test_password_too_short_error(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
        # then check if the user is already exist
    ...
    # check authentication is required and enforced for every endpoint
    # we are currently using Unauthenticated requests so will return error
...
class PrivateUserApiTests(TestCase):
    ...
    # http post should only be used when you're creating objects
